...
public class Daum {
	...
	public static void getDadd(WebDriver driver) {
		...
		//1번째 A 주소 #info\2e search\2e place\2e list > li:nth-child(1) > div.info_item > div.addr > p:nth-child(1)
		//1번째 B 주소 #info\2e search\2e place\2e list > li:nth-child(2) > div.info_item > div.addr > p:nth-child(1)
